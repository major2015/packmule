...
// TODO: we should probably implement a generic method that uses reflection
//       to call the <code>updateFrom</code> method on an object if available.
//       E.g., ForwardingAddressInfo updateObject(
//                     ForwardingAddressInfo from, ForwardingAddressInfo to);
